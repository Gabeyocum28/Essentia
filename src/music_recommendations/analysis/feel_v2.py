...
v1 ran eleven trained classifier heads on the EffNet embedding. Those heads
are Essentia artefacts under a non-commercial licence, and each one is a
separate file to ship. CLAP gives the same thing for free: its text tower
